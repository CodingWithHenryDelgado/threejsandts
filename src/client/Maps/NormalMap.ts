//A better BumpMap
//Uses the RGB values of the image to affect the lighting
//simulates perceived depth in relation the lights
//uses a different algorithm to indicate how much to alter
