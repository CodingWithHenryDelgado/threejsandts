//Used to alter the geometry of a mesh!
//The value of each pixel is used to change the position
//of the vertices of the mesh

//Make sure the plane has many vertices
//The more vertices you have, the more detailed it is
