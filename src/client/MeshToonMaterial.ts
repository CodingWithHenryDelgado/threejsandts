//Toon Matieral is Cel shading! Making a cartoonish smooth gradient effect!
...
const light = new THREE.PointLight(0xff0077, 1)
...
//Uses Three Tone shading for the material
const data = {
...
//Ability to change the gradient map based on object
