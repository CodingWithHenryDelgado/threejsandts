//A texture image that affect the specular surface highlight
//on MeshLambertMaterial and MeshPhongMaterial materials

//Must use the specular and shininess properties to 
//change it

//If used on a MeshPhongMaterial change the reflectivity product
//to adjust the environment map internsity
