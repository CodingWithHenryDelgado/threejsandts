// Using Blender, you can create a model and then adjust the positions, scales and rotations of 
// its parts by creating key frames on the timeline editor.

// Test your animation works by using the play options on the timeline editor in Blender, and 
// then export your model as GLB(preferred) or GLTF with animation options selected for the export.

// After exporting your model, you can drag the GLB/GLTF file from your filesystem, onto this 
// example scene below. It will read the file and create a new checkbox for every animation clip that it finds. 
