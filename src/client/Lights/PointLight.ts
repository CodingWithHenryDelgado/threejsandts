//Light that gets emitted from a single point in all directions
//Distance - Max range of light (Default: 0)
//Decay - The amount the light dims along the distance of light
//(Default: 1)
